...
function page() {
  const Latests = BlogItems[0]
  return (
    <main>
      <h1 className='w-full h-36 flex justify-center items-center text-6xl text-[#3B3B3B] bg-[linear-gradient(91.72deg,#B2B2B2_-16.43%,_#D9D9D9_107.16%)] shadow-[0px_30px_63.2px_-16px_#FFFFFF2B] mb-32 font-semibold'>Blog</h1>
      <Container>
        <section className='flex flex-col gap-7'>
          ...
          <article className='flex gap-20 items-center'>
            ...
            <div className='flex flex-col w-[550px]  text-white gap-3'>
              ...
              <div className='text-lg text-[#AEAEAE] line-clamp-3'>{Latests.text}</div>
