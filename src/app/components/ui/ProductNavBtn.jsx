...
function ProductNavBtn() {
    ...
    return (
        ...
        >
            <div className='text-[#F7F7F7] flex justify-center items-center gap-2 rounded-xl hover:bg-[#66666675] w-32 h-10 cursor-pointer'>
                <span>Products</span>
                <svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12.306 1.40381L7.65536 6.05444C7.29424 6.41556 7.11369 6.59611 6.88932 6.59611C6.66496 6.59611 6.4844 6.41556 6.12329 6.05444L1.47266 1.40381" stroke="#F7F7F7" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
            </div>
