...
function Header() {
  ...
  const navItems = [
    {
      id: 0,
      indexContent: <img src='/images/logo.svg' alt="logo" />,
      href: '/'
    },
    {
      id: 3,
        ...
        <div>
          ...
          >
            <ul className="space-y-1 text-gray-300 px-5 gap-4 flex flex-col">
              <Link href={'/Products/ctd'} onClick={()=>{setIsOpen(false)}}><li className="list-disc">CTD Sensor </li></Link>
              <Link href={'/Products/tds'} onClick={()=>{setIsOpen(false)}}><li className="list-disc">TDS Sensor </li></Link>
              <Link href={'/Products/cl'} onClick={()=>{setIsOpen(false)}}><li className="list-disc">CL Sensor </li></Link>
              <Link href={'/Products/ph'} onClick={()=>{setIsOpen(false)}}><li className="list-disc">PH Sensor </li></Link>
              <Link href={'/Products/ec'} onClick={()=>{setIsOpen(false)}}><li className="list-disc">EC Sensor </li></Link>
            </ul>
          </div>
        </div>
