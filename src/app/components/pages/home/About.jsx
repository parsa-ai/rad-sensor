    ...
    return (
        <section className="relative flex items-center justify-center mb-28">
            <Container className="flex flex-col md:flex-row justify-between gap-10 md:gap-28 h-auto md:h-[470px] relative">
                <article className="flex-1 relative min-h-[270px] md:min-h-[470px]">
                    <div className="w-[300px] h-[200px] md:w-[400px] md:h-[270px] absolute top-0 right-0 md:right-10 z-0 rounded-2xl">
                    ...
                    <div className="w-[200px] h-[180px] md:w-[280px] md:h-[260px] absolute bottom-0 left-0 md:left-10 z-10 rounded-2xl">
            ...
            <HomeAbout className="absolute w-full h-full bottom-[-150px] md:bottom-[-230px]" />
        </section>
    )
}
