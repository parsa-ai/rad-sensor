...
function WhyUs() {
    ...
    return (
        <section className="m-0 md:mt-80 lg:mt-0">
                    ...
                    <Swiper className="mySwiper" loop={true} spaceBetween={30} slidesPerView={1} autoplay={{
                        ...
                        {WhyItems.map((items) => {
                            return (
                                ...
                                <SwiperSlide className="w-80 h-96 min-h-96 rounded-3xl p-8 flex justify-between bg-[linear-gradient(180deg,#FFFFFF_0%,rgba(255,255,255,0.55)100%)]  " style={{
